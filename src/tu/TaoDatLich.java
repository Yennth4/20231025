 ...
 * @author vutu8
 */
public class TaoDatLich extends javax.swing.JFrame {

    /**
     * Creates new form TaoDatLich
     */
    public TaoDatLich() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "VIP", "NORMAL", "GAMING", "LIVESTREAM" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(this, "Bạn đã tạo đặt lịch thành công.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaoDatLich.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
