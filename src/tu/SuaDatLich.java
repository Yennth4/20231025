 ...
 * @author vutu8
 */
public class SuaDatLich extends javax.swing.JFrame {

    /**
     * Creates new form SuaDatLich
     */
    public SuaDatLich() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Khách", "Số Giờ", "Số Máy", "Ngày Bắt Đầu"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel9.setText("THÔNG TIN ĐẶT LỊCH");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(this, "Bạn đã sửa đặt lịch thành công.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaDatLich.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
